        ...
        <div class="ed-sidebar">
          <div class="ed-booking-card" id="booking-card">
            ...
            <div class="ed-card-badges">
              <span class="card-badge visa"><svg viewBox="0 0 48 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="30" rx="4" fill="#1A1F71"/><text x="7" y="21" font-family="Arial,sans-serif" font-size="13" font-weight="bold" font-style="italic" fill="white" letter-spacing="1">VISA</text></svg></span>
              <span class="card-badge mastercard"><svg viewBox="0 0 48 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="30" rx="4" fill="#fff"/><circle cx="19" cy="15" r="8" fill="#EB001B"/><circle cx="29" cy="15" r="8" fill="#F79E1B"/><path d="M24 8.53a8 8 0 010 12.94A8 8 0 0124 8.53z" fill="#FF5F00"/></svg></span>
              <span class="card-badge amex"><svg viewBox="0 0 48 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="30" rx="4" fill="#2E77BC"/><text x="5" y="20" font-family="Arial,sans-serif" font-size="10" font-weight="bold" fill="white" letter-spacing="0.5">AMERICAN</text><text x="5" y="29" font-family="Arial,sans-serif" font-size="10" font-weight="bold" fill="white" letter-spacing="0.5">EXPRESS</text></svg></span>
              <span class="card-badge maestro"><svg viewBox="0 0 48 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="30" rx="4" fill="#fff" stroke="#e0d8dc" stroke-width="1"/><circle cx="19" cy="15" r="8" fill="#003473"/><circle cx="29" cy="15" r="8" fill="#CC0000" fill-opacity="0.85"/><path d="M24 8.53a8 8 0 010 12.94A8 8 0 0124 8.53z" fill="#6600CC" fill-opacity="0.7"/></svg></span>
            </div>
          </div>
